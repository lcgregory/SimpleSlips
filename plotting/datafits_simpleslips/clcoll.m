function P_cosmo = clcoll(coll,sample,Lambda_f,so_f,EL_f,EL_mu,Psi_Cl36_Ca_0,rho_rock,rho_coll,VARS)
...
coll_44_53_coll_58 = VARS.coll_44_53_coll_58;
...
ppmc(59) = coll_44_53_coll_58 - (ppmc(44) + ppmc(45) + ppmc(46) + ppmc(47) + ppmc(48) + ppmc(49) + ppmc(50) + ppmc(51) + ppmc(52) + ppmc(53) + ppmc(58)) ; % O rock in percent
ppmc(60) = O_water ;
ppmc(44) = ppmc(44)*1e+4 ; % in ppmc
ppmc(45) = ppmc(45)*1e+4 ; % in ppmc
ppmc(46) = ppmc(46)*1e+4 ; % in ppmc
ppmc(47) = ppmc(47)*1e+4 ; % in ppmc
ppmc(48) = ppmc(48)*1e+4 ; % in ppmc
ppmc(49) = ppmc(49)*1e+4 ; % in ppmc
ppmc(50) = ppmc(50)*1e+4 ; % in ppmc
ppmc(51) = ppmc(51)*1e+4 ; % in ppmc
ppmc(52) = ppmc(52)*1e+4 ; % in ppmc
ppmc(53) = ppmc(53)*1e+4 ; % in ppmc
...
N_k = (ppm1_61./A_k)*Avogadro*1e-6 ; % Concentrations in atom/g ROCK
N_kc = (ppmc1_61./A_k)*Avogadro*1e-6 ; % Concentrations in atom/g COLLUVIUM
...
f_c_Ca = (Num_k(49)*ppm(62)*1e-6/A_k(49))/(sum(Num_k.*ppmc1_61./A_k)*1e-6) ; % for Ca (ICP)
f_c_K = (Num_k(51)*ppm(51)*1e-6/A_k(51))/(sum(Num_k.*ppmc1_61./A_k)*1e-6) ; % for K
...
Y_s = sum(f_d_k.*Y_n.*ppmc1_61.*Num_k./A_k)/sum(ppmc1_61.*Num_k./A_k) ;
